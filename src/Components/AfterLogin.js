...
const AfterLogin = () => {
    ...
    // const adddQuantityChange = (item , updatedQuantity) => {
        
       
    //     setCartList((prevCartList) => {
    //         const updatedCartList = prevCartList.map((cartItem) => {
    //             // If the current item matches the item being updated, update its quantity
                                                            ...
                                                            <>
                                                                ...
                                                                <div class="row mb-4 d-flex justify-content-between align-items-center">
                                                                    ...
                                                                    <div class="col-md-3 col-lg-3 col-xl-2 d-flex">
                                                                        ...
                                                                        <input id="form1" min="0" name="quantity" value={item.quantity} type="type"
                                                                            class="form-control form-control-sm col-md-1" onChange={(e) => handleQuantityChange(index, parseInt(e.target.value, 10))}/>
